<script lang="ts">
	...
	async function generateLyrics() {
		...
		try {
			...
			lyrics = data.lyrics;
			lyricsGeneratedBy = data.generatedBy || 'Unknown';
		...
		<div class="section-card mb-8 fade-in">
			...
			{:else if lyrics}
				<div class="mb-10">
					...
					{#if lyricsGeneratedBy}
						<div class="text-center mt-4">
							<span class="text-sm px-3 py-1 rounded-full" style="background: var(--rose-light); color: var(--text-secondary);">
								Generated by {lyricsGeneratedBy}
							</span>
						</div>
					{/if}
				</div>
